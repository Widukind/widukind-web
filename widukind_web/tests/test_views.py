...
class ViewsTestCase(TestCase):
    ...
    TODO:
        ...
        /download/dataset/<provider>/<datasetCode> download.datasets_csv GET,
        ...
        /download/list/series/<provider>/<datasetCode> download.fs_list_series GET,
        /download/series/<provider>/<datasetCode>/<key> download.series_csv GET,
        ...
        /views/series/<provider>/<datasetCode> views.series_with_datasetCode GET,
